...
import org.apache.myfaces.jtracc.util.HashMapUtils;
import org.apache.myfaces.jtracc.util.SelectItemsIterator;

/**
 * @author Manfred Geiler (latest modification by $Author: mmarinschek $)
 * @version $Revision: 513799 $ $Date: 2007-03-02 15:03:40 +0000 (Fri, 02 Mar 2007) $
 */
public final class RendererUtils {
    ...
    private static Set internalSubmittedOrSelectedValuesAsSet(FacesContext context,
        ...
        if (values == null || EMPTY_STRING.equals(values)) {
            ...
            HashSet set = new HashSet(org.apache.myfaces.jtracc.util.HashMapUtils.calcCapacity(len));
            for (int i = 0; i < len; i++) {
    ...
    public static Object getConvertedUISelectManyValue(FacesContext facesContext,
        ...
        return org.apache.myfaces.jtracc.renderkit._SharedRendererUtils.getConvertedUISelectManyValue(facesContext,
                                                                                                      selectMany,
     ...
     * 
     * @author mathias (latest modification by $Author: mmarinschek $)
     * @version $Revision: 513799 $ $Date: 2007-03-02 15:03:40 +0000 (Fri, 02 Mar 2007) $
     */
