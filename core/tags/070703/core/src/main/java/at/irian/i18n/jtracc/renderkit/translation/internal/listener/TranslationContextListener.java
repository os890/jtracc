...
public class TranslationContextListener implements ServletContextListener
{
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent)
    {
        ...
        String configFile = servletContextEvent.getServletContext().getInitParameter(Settings.WEB_XML_CONTEXT_PARAMETER_PARAM_NAME_EXT_CONFIG);
        Settings settings = new Settings( configFile );
        servletContextEvent.getServletContext().setAttribute( Settings.BEAN_NAME, settings );

        setupMessagesBean( servletContextEvent, settings );
    ...
    private void setupMessagesBean(ServletContextEvent servletContextEvent, Settings settings)
    {
