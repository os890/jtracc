...
import org.apache.myfaces.jtracc.renderkit.html.util.UnicodeEncoder;
 ...
 * @author Anton Koinov
 * @version $Revision: 511461 $ $Date: 2007-02-25 08:10:54 +0000 (Sun, 25 Feb 2007) $
 */
        ...
        extends ResponseWriter
{
    ...
    public void writeAttribute(String name, Object value, String componentPropertyName) throws IOException
    {
        ...
        else
        {
            ...
            _writer.write(name);
            _writer.write("=\"");
            _writer.write(org.apache.myfaces.jtracc.renderkit.html.util.HTMLEncoder.encode(strValue, false, false, !UTF8.equals(_characterEncoding)));
            _writer.write('"');
        }
    }
    ...
    public void writeText(char cbuf[], int off, int len) throws IOException
    {
        ...
        else
        {
            ...
            // TODO: Make HTMLEncoder support char arrays directly
            String strValue = new String(cbuf, off, len);
            _writer.write(org.apache.myfaces.jtracc.renderkit.html.util.HTMLEncoder.encode(strValue, true, true, !UTF8.equals(_characterEncoding)));
        }
    }
    ...
    private void initializeStartedTagInfo()
    {
        if(_startElementName != null)
        {
            ...
            if(_isStyle == null)
            {
                if(_startElementName.equalsIgnoreCase(org.apache.myfaces.jtracc.renderkit.html.HTML.STYLE_ELEM))
                {
