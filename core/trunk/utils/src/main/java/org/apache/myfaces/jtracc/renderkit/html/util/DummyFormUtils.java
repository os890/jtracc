...
public class DummyFormUtils {
    ...
    public static void writeDummyForm(ResponseWriter writer,
        ...
        writer.startElement(org.apache.myfaces.jtracc.renderkit.html.HTML.FORM_ELEM, null);
        writer.writeAttribute(org.apache.myfaces.jtracc.renderkit.html.HTML.ID_ATTR, DUMMY_FORM_ID, null);
        ...
        writer.writeURIAttribute(org.apache.myfaces.jtracc.renderkit.html.HTML.ACTION_ATTR,
                                 facesContext.getExternalContext().encodeActionURL(actionURL),
                                 null);
        writer.flush();

        StateManager stateManager = facesContext.getApplication().getStateManager();
        org.apache.myfaces.jtracc.renderkit.html.HtmlRendererUtils.writePrettyLineSeparator(facesContext);
        ...
        if (org.apache.myfaces.jtracc.config.MyfacesConfig.getCurrentInstance(facesContext.getExternalContext()).isAutoScroll())
        {
        ...
        if (dummyFormParams != null) {
            org.apache.myfaces.jtracc.renderkit.html.HtmlRendererUtils.renderHiddenCommandFormParams(writer, dummyFormParams);
            org.apache.myfaces.jtracc.renderkit.html.HtmlRendererUtils.renderClearHiddenCommandFormParamsFunction(writer,
                                                                                                                           DUMMY_FORM_NAME,
