...
import org.apache.myfaces.jtracc.component.DisplayValueOnlyCapable;
...
import org.apache.myfaces.jtracc.renderkit.html.util.HTMLEncoder;
...
public final class HtmlRendererUtils {
    ...
    private static void internalRenderSelect(FacesContext facesContext,
        ...
        if (selectMany) {
            ...
            selectItemList = org.apache.myfaces.jtracc.renderkit.RendererUtils
    ...
    public static Set getSubmittedOrSelectedValuesAsSet(boolean selectMany, UIComponent uiComponent, FacesContext facesContext, Converter converter) {
        ...
        if (selectMany) {
            ...
            else if (org.apache.myfaces.jtracc.renderkit.RendererUtils.NOTHING.equals(lookup)) {
    ...
    public static void renderSelectOptions(FacesContext context,
        ...
        for (Iterator it = selectItemList.iterator(); it.hasNext();) {
            ...
            if (selectItem instanceof SelectItemGroup) {
                ...
                String itemStrValue = org.apache.myfaces.jtracc.renderkit.RendererUtils.getConvertedStringValue(context, component,
    ...
    public static boolean renderHTMLAttributeWithOptionalStartElement(
        ...
        throws IOException {
        if (!org.apache.myfaces.jtracc.renderkit.RendererUtils.isDefaultAttributeValue(value)) {
    ...
    public static void renderDisplayValueOnlyAttributes(UIComponent uiComponent, ResponseWriter writer) throws IOException {
        if (!(uiComponent instanceof org.apache.myfaces.jtracc.component.DisplayValueOnlyCapable)) {
    ...
    public static String getDisplayValueOnlyStyleClass(UIComponent component) {
        ...
        if (component instanceof org.apache.myfaces.jtracc.component.DisplayValueOnlyCapable) {
            if (((org.apache.myfaces.jtracc.component.DisplayValueOnlyCapable) component).getDisplayValueOnlyStyleClass() != null)
                return ((org.apache.myfaces.jtracc.component.DisplayValueOnlyCapable) component).getDisplayValueOnlyStyleClass();

            UIComponent parent = component;

            while ((parent = parent.getParent()) != null) {
                if (parent instanceof org.apache.myfaces.jtracc.component.DisplayValueOnlyCapable &&
                    ((org.apache.myfaces.jtracc.component.DisplayValueOnlyCapable) parent).getDisplayValueOnlyStyleClass() != null)
                {
                    return ((org.apache.myfaces.jtracc.component.DisplayValueOnlyCapable) parent).getDisplayValueOnlyStyleClass();
                }
            }
        }
    ...
    public static String getDisplayValueOnlyStyle(UIComponent component) {
        ...
        if (component instanceof DisplayValueOnlyCapable) {
            if (((org.apache.myfaces.jtracc.component.DisplayValueOnlyCapable) component).getDisplayValueOnlyStyle() != null)
                return ((org.apache.myfaces.jtracc.component.DisplayValueOnlyCapable) component).getDisplayValueOnlyStyle();
    ...
    public static boolean isDisplayValueOnly(UIComponent component) {
        ...
        if (component instanceof DisplayValueOnlyCapable) {
            if (((DisplayValueOnlyCapable) component).isSetDisplayValueOnly())
                return ((org.apache.myfaces.jtracc.component.DisplayValueOnlyCapable) component).isDisplayValueOnly();
            ...
            while ((parent = parent.getParent()) != null) {
                if (parent instanceof DisplayValueOnlyCapable &&
                    ...
                    return ((org.apache.myfaces.jtracc.component.DisplayValueOnlyCapable) parent).isDisplayValueOnly();
                }
            }
        }
    ...
    public static void renderDisplayValueOnly(FacesContext facesContext, UIComponent input) throws IOException {
        ResponseWriter writer = facesContext.getResponseWriter();
        writer.startElement(org.apache.myfaces.jtracc.renderkit.html.HTML.SPAN_ELEM, input);
