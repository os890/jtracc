 ...
 * under the License.
 */
package org.apache.myfaces.jtracc.taglib;
        ...
        extends UIComponentBodyTag
{
        ...
        if (log.isWarnEnabled())
        {
                ...
                !isBodyContentEmpty())
            {
                log.warn("Component with id '" + component.getClientId(getFacesContext()) +
                         "' (" + getClass().getName() +
                         " tag) and path : "+org.apache.myfaces.jtracc.renderkit.RendererUtils.getPathToComponent(component)+"renders it's children, but has embedded JSP or HTML code. Use the <f:verbatim> tag for nested HTML. For comments use <%/* */%> style JSP comments instead of <!-- --> style HTML comments." +
    ...
    protected void setProperties(UIComponent component)
    {
        ...
        setBooleanProperty(component, org.apache.myfaces.jtracc.renderkit.JSFAttr.FORCE_ID_INDEX_ATTR, _forceIdIndex);
