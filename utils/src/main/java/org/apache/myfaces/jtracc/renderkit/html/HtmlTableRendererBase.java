 ...
 * @version $Revision: 483569 $ $Date: 2006-12-07 17:49:35 +0000 (Thu, 07 Dec 2006) $
 */
public class HtmlTableRendererBase extends HtmlRenderer
{
    ...
    public void encodeBegin(FacesContext facesContext, UIComponent uiComponent) throws IOException
    {
        ...
        HtmlRendererUtils.renderHTMLAttributes(writer, uiComponent, org.apache.myfaces.jtracc.renderkit.html.HTML.TABLE_PASSTHROUGH_ATTRIBUTES);
    }
        ...
        Styles styles, int rowStyleIndex) throws IOException
    {
        ...
        Object rowId = uiData.getAttributes().get(org.apache.myfaces.jtracc.renderkit.JSFAttr.ROW_ID);
    ...
    protected static String getHeaderClass(UIComponent component)
    {
        ...
        {
            return (String) component.getAttributes().get(org.apache.myfaces.jtracc.renderkit.JSFAttr.HEADER_CLASS_ATTR);
        }
    }
    ...
    protected static String getFooterClass(UIComponent component)
    {
        ...
        {
            return (String) component.getAttributes().get(org.apache.myfaces.jtracc.renderkit.JSFAttr.FOOTER_CLASS_ATTR);
        }
    }
