...
public final class MessageUtils
{
    ...
    public static FacesMessage getMessage(Locale locale, String messageId, Object params[])
    {
        ...
        if (bundleName != null)
        {
            try
            {
                bundle = ResourceBundle.getBundle(bundleName, locale, org.apache.myfaces.jtracc.util.ClassUtils.getCurrentLoader(bundleName));
        ...
        if (summary == null)
        {
            try
            {
                bundle = ResourceBundle.getBundle(DEFAULT_BUNDLE, locale, org.apache.myfaces.jtracc.util.ClassUtils.getCurrentLoader(DEFAULT_BUNDLE));
                if(bundle == null)
                {
